...
<body>
    <div class="container-fluid">
        <div class="row">
            ...
            <img src="like.jpg"   style="height:800px;"  alt="police">
            <table class="table">
                <thead>
                    <tr>
...
<body>
    <div class="container">
        <div class="row">
            <div class="col-sm-12 bg-info h1 text-center">Bureau of Police Research and Development</div>
            <div class="col-sm-4 h2 bg-info bg-primary"><a href="/static/sample.html">HOME</a></div>
            <div class="col-sm-4 h2  bg-info bg-primary"><a href="/static/about.html">ABOUT US</a></div>
            <div class="col-sm-4 h2  bg-info bg-primary"><a href="/static/gallery.html">GALLERY</a></div>
...
## Result:
Thus the program to create a website using bootstrap is completed successfully.
